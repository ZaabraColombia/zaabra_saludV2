...
class CumsSeeder extends Seeder
{
    ...
    {
        Cums::query()->truncate();
        $csvFile = fopen(base_path("database/data/IUM-2022-02-18.csv"), "r");
            ...
            if (!$firstline) {
                ...
                try {
                    $create = new Cums([
                        ...
                        "amount_cum"            => !empty($data[9]) ? (double) $data[9]:null,
                        ...
                        "amount"                => !empty($data[22]) ? (double) $data[22]:null,
