...
<div id="sidebar" class="active">
        <div class="sidebar-wrapper active ps ps--active-y">
            <div class="sidebar-menu">
                ...
                <ul class="menu">
                    <a id="menu_panel" class="actived" href="{{ url('/panelPrincipal') }}" class="">Menu</a>
                            ...
                            <ul class="submenu active">
                                ...
                                @foreach($objListaUsuario1 as $key => $objListaUsuario1)
                                    <li class="submenu-item ">
                                        <a id="cita{{$key}}" class="actived" href='{{url("$objListaUsuario1->urlPermiso")}}'>{{$objListaUsuario1->nombrePermiso}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu active">
                                @foreach($objListaUsuario3 as $objListaUsuario3)
                                    <li class="submenu-item ">
                                        <a id="fav" class="actived" href='{{url("$objListaUsuario3->urlPermiso")}}'>{{$objListaUsuario3->nombrePermiso}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
