...
<div class="container-fluid">
    ...
    <section class="section_infoZaabra">
        <h5 class="titulo_infoZaabra"> ¿Dudas? ¿Inquietudes? </h5>
        <p class="subTitulo_infoZaabra"> En esta sección resolveremos todas las preguntas más frecuentes sobre Zaabra salud. </p>
        ...
        <div class="mb-3 mb-md-5 evento_acordion accordion_infoZaabra" id="accordion">
            <div class="card options_collapse_infoZaabra">
                <div id="headingOne"> <!-- Función del desplegable con cambio de color se encuentra ubicado en el archivo footer.js -->
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> ¿Qué es Zaabra Salud? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="card-body toggle_infoZaabra">
                        ...
                        <ul class="option_toggle_infoZaabra mb-0">
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingThree">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> ¿Quién puede utilizar Zaabra Salud? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingFour">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> ¿Cómo me registro en Zaabra Salud? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingFive">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive"> ¿Puedo registrarme bajo más de un tipo de perfil? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingSix">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix"> ¿Debo pagar para registrarme? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingSeven">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven"> ¿Cuáles especialidades puedo conseguir en Zaabra Salud? </button>
                </div>
                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
                    <div class="card-body toggle_infoZaabra">
                        ...
                        <ul class="option_toggle_infoZaabra mb-2">
                            <li> Medicina.</li>
                            <li> Odontología.</li>
                            <li> Sicología.</li>
                            <li> Fisioterapia.</li>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingEight">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight"> ¿Cuáles tipos de entidades puedo conseguir en Zaabra Salud? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingNine">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine"> ¿Puedo tener más de una cita agendada? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingTen">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen"> ¿Puedo agendar una cita para un tercero? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingEleven">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven"> Para agendar una cita, ¿Debo pagarla? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingTwelve">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve"> ¿Puedo hacer modificaciones o cancelaciones sobre una cita agendada? </button>
                </div>
            ...
            <div class="card options_collapse_infoZaabra">
                <div id="headingThirteen">
                    <button class="btn_collapse_off_infoZaabra" onclick="colorBtnToggle(this)" data-toggle="collapse" data-target="#collapseThirteen" aria-expanded="false" aria-controls="collapseThirteen"> ¿Zaabra Salud garantiza la seguridad y privacidad de mi información y datos personales? </button>
                </div>
