...
@section('contenido')
    <div class="container-fluid panel_container">
        ...
        <div class="panel_head">
            <!-- Title -->
            <h1 class="mb-3 title blue_two">Editar convenio</h1>
        </div>
        <!-- panel body -->
        <div class="panel_body">
            <div class="container__form mb-3">
                <form action="{{ route('profesional.configuracion.convenios.update', ['convenio' => $convenio->id]) }}" method="post" id="form-convenio-crear" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <select class="select2 input__select @error('sgsss_id') is-invalid @enderror" type="text" id="sgsss_id" name="sgsss_id" required>
                                @if(!empty($sgsss))
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <input class="input__text @error('codigo_convenio') is-invalid @enderror" type="text" id="codigo_convenio" name="codigo_convenio" value="{{ old('codigo_convenio', $convenio->codigo_convenio) }}" required/>
                        </div>

                        <div class="col-md-6 col-xl-4 mb-3">
                            <label class="label_fs16_med black_" for="tipo_contribuyente_id">Tipo de contribuyente</label>
                            <select class="input__select @error('tipo_contribuyente_id') is-invalid @enderror" id="tipo_contribuyente_id" name="tipo_contribuyente_id" required>
                                <option value=""></option>
                                @if(!empty($tipo_contribuyentes) and $tipo_contribuyentes->isNotEmpty())
                                    @foreach($tipo_contribuyentes as $contribuyente)
                                        <option value="{{ $contribuyente->id }}" {{ old('tipo_contribuyente_id', $convenio->tipo_contribuyente_id) == $contribuyente->id ? 'selected':null }}>{{ $contribuyente->nombre }}</option>
                                    @endforeach
                                @endif
                                <option value=""></option>
                            </select>
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            @php $actividad_economica = (!empty( old('actividad_economica_id', $convenio->actividad_economica_id) )) ? \App\Models\ActividadEconomica::find(old('actividad_economica_id', $convenio->actividad_economica_id)):null; @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <input class="input__text @error('direccion') is-invalid @enderror" type="text" id="direccion" name="direccion" value="{{ old('direccion', $convenio->direccion) }}" required/>
                        </div>

                        <div class="col-md-6 col-xl-4 mb-3">
                            <label class="label_fs16_med black_" for="codigo_postal">Código postal</label>
                            <input class="input__text @error('codigo_postal') is-invalid @enderror" type="text" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal', $convenio->codigo_postal) }}" required/>
                        </div>

                        <div class="col-md-6 col-xl-4 mb-3">     <!--menu dinamico ciudades -->
                            <label class="label_fs16_med black_" for="pais_id">País</label>
                            <select class="select2 pais input__select @error('pais_id') is-invalid @enderror" id="pais_id" name="pais_id"
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            @php $departamento = (old('departamento_id', $convenio->departamento_id) === null)?null:\App\Models\departamento::query()->where('id_departamento', old('departamento_id', $convenio->departamento_id))->first()@endphp
                            <label class="label_fs16_med black_" for="departamento_id">Departamento</label>
                            {{-- @dd(old('departamento_id'))--}}
                            <select class="select2 departamento input__select @error('departamento_id') is-invalid @enderror" name="departamento_id" id="departamento_id"
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            @php $provincia = (old('provincia_id', $convenio->provincia_id) === null)?null:\App\Models\provincia::query()->where('id_provincia', old('provincia_id', $convenio->provincia_id))->first()@endphp
                            <label class="label_fs16_med black_" for="provincia_id">Provincia</label>
                            <select class="select2 provincia input__select @error('provincia_id') is-invalid @enderror" name="provincia_id" id="provincia_id" data-ciudad="#ciudad_id" data-id="{{ old('provincia_id', $convenio->provincia_id) }}">
                                @if(!empty($provincia))
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            @php $ciudad = (old('ciudad_id', $convenio->ciudad_id) === null)?null:\App\Models\municipio::query()->where('id_municipio', old('ciudad_id', $convenio->ciudad_id))->first()@endphp
                        ...
                        <div class="col-md-6 col-xl-4 mb-3">
                            ...
                            <input class="input__text @error('telefono') is-invalid @enderror" type="text" id="telefono" name="telefono" value="{{ old('telefono', $convenio->telefono) }}"/>
                        </div>

                        <div class="col-md-6 col-xl-4 mb-3">
                            <label class="label_fs16_med black_" for="celular">Móvil</label>
                            <input class="input__text @error('celular') is-invalid @enderror" type="text" id="celular" name="celular" value="{{ old('celular', $convenio->celular) }}"/>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="label_fs16_med black_" for="correo">Correo</label>
                            <input class="input__text @error('correo') is-invalid @enderror" type="email" id="correo" name="correo" value="{{ old('correo', $convenio->correo) }}"required/>
                        </div>
                    </div>
                    <!-- Buttons -->
                    <div class="btn__down_form">
                        <a href="{{ route('profesional.configuracion.convenios.index') }}" class="bord_gray_70">Cancelar</a>
