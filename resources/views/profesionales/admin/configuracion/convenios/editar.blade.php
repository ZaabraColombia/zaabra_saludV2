    ...
    <div class="container-fluid p-0 pr-lg-4">
        <div class="containt_agendaProf">
            <div class="my-4 my-xl-5">
                <h1 class="title__xl blue_bold">Editar Convenio</h1>
            </div>

            <div class="containt_main_table mb-3">
                <form action="{{ route('profesional.configuracion.convenios.update', ['convenio' => $convenio->id]) }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 input__box">
                            ...
                            <select type="text" id="sgsss_id" name="sgsss_id" required
                        ...
                        <div class="col-md-4 input__box">
                            ...
                            <select class="@error('tipo_contribuyente_id') is-invalid @enderror" id="tipo_contribuyente_id"
                                    name="tipo_contribuyente_id" required>
                                <option value=""></option>
