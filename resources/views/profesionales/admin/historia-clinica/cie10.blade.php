...
@section('contenido')
    <div class="container-fluid panel_container">
        ...
        <div class="panel_head m-md-0 mb-lg-3">
            <!-- Title -->
            <h1 class="title blue_two mb-3 mb-md-0 mb-lg-3">Diagnósticos (CIE - 10)</h1>
            <!-- Toolbar -->
            <div class="row m-0">
                <!-- Subtitle -->
                <div class="col-md-9 col-lg-10 p-0 mb-4 mb-md-0 d-md-flex align-items-md-center align-items-lg-baseline">
                    <h2 class="text-center text-lg-left h2_fs20_bold black_">Consulte el documento de diagnóstico (CIE - 10).</h2>
                </div>
