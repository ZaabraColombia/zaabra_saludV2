            ...
            <div id="tarjeta" class="card tarjeta_principal margInferior">
                ...
                <div class="card-body pt-md-4 pb-md-5">
                    <form method="POST" action="{{ route('register') }}" onsubmit="return validateform()"
                          name="formularioRegistro" data-position="{{ old('idrol') }}" id="form-registrar">
                        @csrf
                        <div class="seccion_opcion_usuario"> <!-- Oopciones de registro -->
                            <div class=" seccion_opcion_registro">
                                ...
                                <input id="inpt1" class="input_registro" onclick="hideForm(this)" type="image" src="{{ asset('img/iconos/icono-paciente.svg') }}" value="1"  data-position="paciente">
                            ...
                            <div class=" seccion_opcion_registro">
                                ...
                                <input id="inpt2" class="input_registro" onclick="hideForm(this)" type="image" src="{{ asset('img/iconos/icono-doctor.svg') }}"  value="2"  data-position="doctor">
                            ...
                            <div class=" seccion_opcion_registro">
                                ...
                                <input id="inpt3" class="input_registro" onclick="hideForm(this)" type="image" src="{{ asset('img/iconos/icono-institucion.svg') }}"  value="3"  data-position="institucion">
                                <label id="txt3" class="txt_opcion_registro" for="idrol"> Institución </label>
                            </div>
                        </div>

                        <div class="seccion_opcion_usuario">
                            @if($errors->any())
                                <div class="col-12">
                        ...
                        <div id="persona"> <!-- Nombres y apellidos persona -->
                            ...
                            <div class="names_person my-3">
                                ...
                                <div class="d-md-flex">
                                    <input id="primernombre" type="text" class="input_form form-control mb-2 mr-md-1 @error('primernombre') is-invalid @enderror" name="primernombre" value="{{ old('primernombre') }}"
                                           autocomplete="primernombre" autofocus placeholder="Primer Nombre">
                                    <input id="segundonombre" type="text" class="input_form form-control mb-3 ml-md-1 @error('segundonombre') is-invalid @enderror" name="segundonombre" value="{{ old('segundonombre') }}"
                                ...
                                <div class="d-md-flex">
                                    <input id="primerapellido" type="text" class="input_form form-control mb-2 mr-md-1 @error('primerapellido') is-invalid @enderror" name="primerapellido" value="{{ old('primerapellido') }}"
                                           autocomplete="primerapellido" autofocus placeholder="Primer Apellido">
                                    <input id="segundoapellido" type="text" class="input_form form-control ml-md-1 @error('segundoapellido') is-invalid @enderror" name="segundoapellido"
                        ...
                        <div id="institucion" class="names_institution mt-3"> <!-- Nombre institución -->
                            ...
                            <input id="nombreinstitucion" type="text" class="input_form form-control mb-3 @error('nombreinstitucion') is-invalid @enderror" name="nombreinstitucion" value="{{ old('nombreinstitucion') }}"
                        ...
                        <div class="datos_secundarios"> <!-- Datos secundarios -->
                            ...
                            <select class="input_form form-control mb-3 @error('tipodocumento') is-invalid @enderror" name="tipodocumento" required>
                                <option></option>
                                @foreach($tipo_documentos as $tipo)
                                    <option value="{{ $tipo->id }}" {{ old('tipodocumento') == $tipo->id? 'selected':'' }}>{{ $tipo->nombre }}</option>
                                @endforeach
                            </select>

                            <label for="numerodocumento" class="texto_label">{{ __('Numero Documento *') }}</label>

                            <input id="numerodocumento" type="text" class="input_form form-control mb-3 @error('numerodocumento') is-invalid @enderror" name="numerodocumento" value="{{ old('numerodocumento') }}"
                                   autocomplete="numerodocumento" autofocus>

                            <label for="email" class="texto_label">{{ __('Correo electrónico *') }}</label>

                            <input id="email" type="email" class="input_form form-control mb-3 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" required placeholder="servicioalcliente@zaabrasalud.co">

                            <label for="password" class="texto_label">{{ __('Contraseña *') }}</label>

                            <input id="password" type="password" class="input_form form-control mb-3 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Contraseña">

                            <label for="password-confirm" class="texto_label">{{ __('Confirmar contraseña *') }}</label>

                            <input id="password-confirm" type="password" class="input_form form-control mb-3  @error('password-confirm') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password" placeholder="Contraseña">
                            ...
                            <div class="d-flex"> <!-- Check Políticas y terminos -->
                                ...
                                <label class="txt_check" for="aceptoTerminos"> Declaro que he leído y acepto la
                            ...
                            <div class="d-flex mt-2"> <!-- Check de Promociones -->
                                <input type="checkbox" class="accepted-promo" id="accepted-promo">

                                <label class="txt_check" for="accepted-promo">Me gustaría recibir comunicaciones promocionales.</label>
                            </div>
...
@section('scripts')
    ...
    <script>
        window.onload = () => {
            hideForm(document.querySelector('#form-registrar'));
        }
    </script>
@endsection
