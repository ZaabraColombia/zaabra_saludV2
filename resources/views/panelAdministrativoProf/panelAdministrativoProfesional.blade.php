...
@section('content')
    <div class="row m-0 p-0">
        <div class="col-2 col-lg-3 col-xl-2 d-none d-lg-block p-0 bg-light sidebar" style="height: fit-content;">
            @include('menuAdminProfesional')
        </div>

        <div class="col-12 col-lg-9 col-xl-10 panel-Administrativo_prof">
