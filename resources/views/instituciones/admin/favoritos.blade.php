                ...
                <div class="card-content">
                    <div class="card-body container_table_fav">
                        ...
                        @if(!empty($objFavorito))
                            ...
                            <form id="favorito_especialidad" class="d-none" method="post" action="{{ route('institucion.favoritos.guardar_especialidades') }}"
                        ...
                        @else
                        <form id="favorito_especialidad" method="post" action="{{ route('institucion.favoritos.guardar_especialidades') }}"
                                enctype="multipar/form-data" accept-charset="UTF-8">
                ...
                <div class="card-content">
                    <div class="card-body container_table_fav">
                        ...
                        @if(!empty($objFavoritoServicio))
                            ...
                            <form id="favorito_servicio" class="d-none" method="post" action="{{ route('institucion.favoritos.guardar_servicios') }}"
                                    enctype="multipar/form-data" accept-charset="UTF-8">
                        ...
                        @else
                            <form id="favorito_servicio" method="post" action="{{ route('institucion.favoritos.guardar_servicios') }}"
                                    enctype="multipar/form-data" accept-charset="UTF-8">
                                <div class="table-responsive section_tableCitas">
                ...
                <div class="card-content">
                    <div class="card-body container_table_fav">
                        ...
                        @if(!empty($objFavoritoEspec))
                            ...
                            <form id="favorito_especialista" class="d-none" method="post" action="{{ route('institucion.favoritos.guardar_profesional') }}"
                                    enctype="multipar/form-data" accept-charset="UTF-8">
                        ...
                        @else
                            <form id="favorito_especialista" method="post" action="{{ route('institucion.favoritos.guardar_profesional') }}" enctype="multipar/form-data" accept-charset="UTF-8">
                                <div class="table-responsive section_tableCitas">
                                    <label for="example-date-input" class="text_label-formInst"> Ingrese servicio </label>
                ...
                <div class="card-content">
                    <div class="card-body container_table_fav">
                        ...
                        @if(!empty($objFavoritoInst))
                            ...
                            <form id="favorito_institucion" class="d-none" method="post" action="{{ route('institucion.favoritos.guardar_instituciones') }}"
                                    enctype="multipar/form-data" accept-charset="UTF-8">
                        ...
                        @else
                            <form id="favorito_institucion" method="post" action="{{ route('institucion.favoritos.guardar_instituciones') }}"
                                    enctype="multipar/form-data" accept-charset="UTF-8">
                                <div class="table-responsive section_tableCitas">
                                    <label for="example-date-input" class="text_label-formInst"> Ingrese servicio </label>
