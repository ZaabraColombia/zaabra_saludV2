    ...
    <div class="container-fluid panel_container">
        <div class="panel_head">
            ...
            <div class="row m-0">
                ...
                <div class="col-md-12 col-lg-auto mr-lg-3 button__add_card">
                    <a href="{{ route('institucion.configuracion.convenios.create') }}" class="button__green_card" id="btn-agregar-contacto">Agregar convenio</a>
                </div>
                <!-- Search bar -->
        ...
        <div class="panel_body">
            <div class="row m-0">
                ...
                @endif
                <!-- Pagination buttons -->
                {{ $convenios->links("pagination::simple-bootstrap-4") }}               
            </div>
        </div>
    </div>
