...
<div class="container-fluid panel_container">
        <div class="panel_container_form">
            <!-- Main title -->
            <div class="mb-4">
                <h1 class="fs_title_module green_bold">Agregar convenio</h1>
            </div>
            <!-- Formulario -->
            <div class="container__main_form">
                <form action="{{ route('institucion.configuracion.convenios.store') }}" method="post" id="form-convenio-crear" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        @if($errors->any())
                            <div class="col-12">
                    ...
                    <div class="d-block d-md-flex justify-content-end py-3">
                        ...
                        <div class="checkbox">
                            <input type="checkbox" {{ old('estado') == 1 ? 'checked':'' }} name="estado" id="conv_check">
                        ...
                        <div class="col-md-6 mb-3 input__box">
                            ...
                            <div class="row m-0">
                                ...
                                <input class="col-2 m-0 no_brad_left @error('dv_documento') is-invalid @enderror" type="text"
                                        id="dv_documento" name="dv_documento" value="{{ old('dv_documento') }}"/>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 input__box mb-3">     <!--menu dinamico ciudades -->
                        ...
                        <div class="col-md-6 col-lg-4 input__box mb-3">
