...
<div class="container-fluid">
  <section class="section_principal-institucion">
    <h1 class="titulo_membresia_inst"> ESCOJA SU PLAN </h1>
    <p class="subtitulo_membresia_inst"> Escoja el que se ajuste a sus necesidades. </p>

    <!-- Seccion opciones paara Registrarse -->
    <div class="section_inputs-option-institucion">
      <div class="form-check input_option-institucion">
    ...
    <div class="evento_acordion contain_accordion-institucion" id="accordion1">
      <h2 class="titulo_tarjeta-institucion"> Plan Gratuito </h2>
      <p class="subtitulo_membresia_inst"> Inícielo gratis hoy y después conviértase al Premium. </p>
      ...
      <!-- Botón Registrar -->
      <div class="containt_btn_membresia_inst">
        <a href="{{route('register')}}">
          <button type="submit" class="btn_registro_membresia_inst"> {{ __('Registro') }}
    ...
    <div class="evento_acordion contain_accordion-institucion" id="accordion">
      ...
      <div class="content_collapse_membresia_inst">
      ...
      <!-- Botón Empezar -->
      <div class="containt_btn_membresia_inst">
        <button type="submit" class="btn_inicio_membresia_inst" data-toggle="modal" data-target="#exampleModal"> {{ __('Empezar') }}
          <img src="{{URL::asset('/img/iconos/icono-flecha-blanco.svg')}}" class="flecha_ingreso-institucion" alt="">
        </button>
      </div>
    </div>
