...
<div class="container-fluid">
  <section class="section_principal-institucion">
    ...
    <div class="contain_accordion-institucion" id="accordion">
      ...
      <p class="texto_inferior-institucion"> Puede complementar y personalizar su plan con recursos publicitarios adicionales. <a class="contac_institucion" href=""> Contáctenos </a> para ser atendido por un representante. *Vigencia anual. </p>
