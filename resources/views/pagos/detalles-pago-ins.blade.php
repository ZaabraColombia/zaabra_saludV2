    ...
    <div class="container pt-3 pt-lg-5">
        ...
        <div class="row mb-4">
            <div class="col-12 col-lg-7 mb-4 mb-lg-0">
                ...
                <p class="fs_subtitle black_light font_roboto">Dr.(a) {{ $pagoCita->cita->profesional_ins->nombre_completo }}</p>
                <span class="fs_subtitle black_light font_roboto">Especialidad:</span>
                <span class="fs_subtitle black_light font_roboto">{{ $pagoCita->cita->especialidad->nombreEspecialidad }}</span>
                ...
                <p class="fs_subtitle black_light font_roboto">Dirección:
                    <span>{{ "{$pagoCita->cita->lugar} ({$pagoCita->cita->ciudad->nombre})" }}</span>
                </p>
