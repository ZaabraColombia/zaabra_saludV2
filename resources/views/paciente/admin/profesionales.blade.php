                        ...
                        @if($profesionales->isNotEmpty())
                            @foreach($profesionales as $profesional)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn_action" style="width: 33px" href="{{ route('PerfilProfesional', ['slug' => $profesional->slug]) }}" target="_blank">
                                            <i data-feather="external-link"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn_action" style="width: 33px" href="{{ route('paciente.asignar-cita-profesional', ['profesional' => $profesional->slug]) }}">
                        ...
                        @if($profesionales_ins->isNotEmpty())
                            @foreach($profesionales_ins as $profesional)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn_action" style="width: 33px" href="{{ route('PerfilInstitucion', ['slug' => $profesional->institucion->slug]) }}" target="_blank">
